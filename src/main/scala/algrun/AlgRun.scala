...
object AlgRun {
  def main(args: Array[String]) = {
    ...
    println("---STRUCTURES---")
    println("IntAdd")
    println(PropertyChecker.checkAsAbelianGroup[Int](IntAdd(), intGen))
    println("IntDivide")
    println(PropertyChecker.checkAsAbelianGroup[Int](IntDivide(), intGen))
    println("StringConcat")
    println(PropertyChecker.checkAsMonoid[String](StringConcat(), stringGen))
    println("---SETS---")
